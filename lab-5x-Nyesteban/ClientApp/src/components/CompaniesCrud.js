...
function CompaniesCrud() {
    ...
    async function Load() {
        ...
        const result = await axios.get("http://ec2-13-50-235-125.eu-north-1.compute.amazonaws.com/api/Companies");
        setCompanies(result.data);
        console.log(result.data);
        const resultGames = await axios.get("http://ec2-13-50-235-125.eu-north-1.compute.amazonaws.com/api/Companies/GameRating");
    ...
    async function save(event) {
        ...
        try {
            await axios.post("http://ec2-13-50-235-125.eu-north-1.compute.amazonaws.com/api/Companies", {
    ...
    async function DeleteCompany(id) {
        await axios.delete("http://ec2-13-50-235-125.eu-north-1.compute.amazonaws.com/api/Companies/" + id);
    ...
    async function update(event) {
        ...
        try {
            ...
            await axios.put("http://ec2-13-50-235-125.eu-north-1.compute.amazonaws.com/api/Companies/" + companies.find((u) => u.id === id).id || id,
                {
                    ID: id,
                    CompanyName: companyName,
                    CompanyDescription: companyDescription,
